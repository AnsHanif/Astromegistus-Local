...
export default function MeetOurTeam() {
  return (
    <div className="px-4 sm:px-12 py-16">
      <h1 className="text-size-heading md:text-size-primary text-center font-bold mb-2">
        Meet the Team
      </h1>
      <p className="text-size-tertiary font-normal max-w-[700px] mx-auto text-center mb-8">
            ...
            <div className="absolute inset-0 flex flex-col justify-end">
              <div className="bg-gradient-to-t from-[#000000] via-black/70 to-transparent p-4">
                <div className="pl-3 border-l-2 border-white">
                  <h3 className="font-semibold text-size-large">
                    {member.name}
                  </h3>
                  <p className="text-size-small font-normal">{member.role}</p>
                  {member.desc && (
                    <p className="text-size-small font-normal mt-5">
                      {member.desc}
                    </p>
                  )}
                </div>
